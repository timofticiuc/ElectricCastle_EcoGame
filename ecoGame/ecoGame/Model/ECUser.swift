    ...
    var userCategories:[ECCategory]! {
        get {
            ...
            for categoryId in categoryIds {
                let persistedCategory = ECCategory.objectWithIdentifier(categoryId, fromContext: ECCoreManager.sharedInstance.storeManager.managedObjectContext!) as! ECCategory
